...
You must use [these steps]({{ site.data.urls.SkillManualAuth | liquify }}) to manually configure Authentication for the Email Skill. Due to a change in the Skill architecture this is not currently automated. 
